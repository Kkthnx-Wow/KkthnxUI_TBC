...
function Module:PositionAltPowerBar()
	...
	holder:SetPoint("TOP", UIParent, "TOP", -1, -60)
	...
	K.Mover(holder, "PlayerPowerBarAlt", "Alternative Power", {"TOP", UIParent, "TOP", -1, -60}, AltPowerWidth or 250, AltPowerHeight or 20)
end
