...
PvPIndicator - A `Texture` used to display faction, FFA PvP status.
...
-- 	* self          - the PvPIndicator element
-- 	* unit          - the unit for which the update has been triggered (string)
-- 	* status        - the unit's current PvP status or faction accounting for mercenary mode (string)['ffa', 'Alliance','Horde']
-- 	--]]
