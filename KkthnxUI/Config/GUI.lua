...
local Announcements = function(self)
	...
	-- Window:CreateSwitch("Announcements", "Daily", "Add 'Daily' Prefix To Quest If Weekly")
	-- Window:CreateSwitch("Announcements", "IncludeDetails", "Show Quest Details")
	-- Window:CreateSwitch("Announcements", "Level", "Show Quest Level Tag")
	-- Window:CreateSwitch("Announcements", "LevelHideOnMax", "Hide Level Tag If Quest Is Max Level For Expansion.")
	-- Window:CreateSwitch("Announcements", "Paused", "Pause Quest Announcements")
	-- Window:CreateSwitch("Announcements", "SuggestedGroup", "Add Number Of Players Needed For Quest")
	-- Window:CreateSwitch("Announcements", "Tag", "Show Quest Tags")
	-- Window:CreateSwitch("Announcements", "Weekly", "Add 'Weekly' Prefix To Quest If Weekly")
end
...
local Skins = function(self)
	...
	Window:CreateSwitch("Skins", "TinyInspect", newFeatureIcon.."TinyInspect Skin")
